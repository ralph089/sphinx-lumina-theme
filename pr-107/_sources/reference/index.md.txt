...
:icon: list
:icon-style: featured
Ordered, unordered, task lists, Markdown tables, and list tables.
:::
...
:icon: layout-grid
:icon-style: featured
Card layouts, responsive grids, and common layout patterns.
:::

:::{grid-item-card} Images & Figures
:link: images-and-figures
:link-type: doc
:icon: image
:icon-style: featured
Responsive images, figures with captions, alignment, and file format guidance.
:::

:::{grid-item-card} Badges & Buttons
:link: badges-and-buttons
:link-type: doc
:icon: badge-check
:icon-style: featured
Inline status badges and clickable button links.
:::
...
:icon: sigma
:icon-style: featured
Inline and display equations, labeled references, matrices, and symbol tables.
:::
...
:::{grid-item-card} Footnotes & References
:link: footnotes-and-references
:link-type: doc
:icon: link
:icon-style: featured
Cross-references, glossaries, intersphinx, version directives, and downloads.
:::
